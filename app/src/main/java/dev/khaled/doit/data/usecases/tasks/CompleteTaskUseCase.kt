...
) : UseCase<CompleteTaskParams, UiState<Pair<Task, String>>> {
    override suspend fun invoke(parameters: CompleteTaskParams): UiState<Pair<Task, String>> {
        return suspendCancellableCoroutine { continuation ->
            taskRepo.completeTask(parameters.task) { result ->
